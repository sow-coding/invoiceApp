...
function SideBar (props) {
  return (
    <nav className={`${styles.sideBar} ${props.position} ${props.customClassName}`}>
      ...
      <svg onClick={() => (
        window.alert("The dark mode is not available yet")
      )} className={`${styles.shadowMode}`} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
